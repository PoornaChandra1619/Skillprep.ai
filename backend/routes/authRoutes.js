...
const client = new OAuth2Client(process.env.GOOGLE_CLIENT_ID || "781290030877-jck1t8r7ue35skj8llrdm0tg1u88cj8p.apps.googleusercontent.com");
...
router.post("/google", async (req, res) => {
  try {
    ...
    const ticket = await client.verifyIdToken({
      idToken,
      audience: process.env.GOOGLE_CLIENT_ID || "781290030877-jck1t8r7ue35skj8llrdm0tg1u88cj8p.apps.googleusercontent.com",
    });
